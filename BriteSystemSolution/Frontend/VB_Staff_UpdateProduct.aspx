<%@ Page Title="Update Product" Language="C#" MasterPageFile="~/VB_MasterPage.master" AutoEventWireup="true" CodeFile="VB_Staff_UpdateProduct.aspx.cs" Inherits="Staff_SearchProduct" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
  ...
  <tr>
    ...
    <td style="width: 225px; text-align:center " rowspan="2" >
        <asp:ImageButton ID="BtnSave" OnClick="BtnSave_Click" runat="server" Height="125px" ImageAlign="Middle" ImageUrl="~/Buttons/Save.jpg" Width="125px" />
           </tr>
      <tr>
