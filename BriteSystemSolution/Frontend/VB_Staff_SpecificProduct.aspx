<%@ Page Title="Product Details" Language="C#" MasterPageFile="~/VB_MasterPage.master" AutoEventWireup="true" CodeFile="VB_Staff_SpecificProduct.aspx.cs" Inherits="Staff_SearchProduct" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
  ...
  <tr>
    ...
    <td style="width: 225px; text-align:center " rowspan="2" >
        <asp:ImageButton ID="BtnDelete" OnClick="BtnDelete_Click" runat="server" ImageUrl="~/Buttons/Delete.jpg" Width="125PX" Height="125px" ImageAlign="Middle" /></tr>
      <tr>
