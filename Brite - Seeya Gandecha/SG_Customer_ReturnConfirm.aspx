<%@ Page Title="Return Confirmation" Language="C#" MasterPageFile="~/SG_MasterPage.master" AutoEventWireup="true" CodeFile="SG_Customer_ReturnConfirm.aspx.cs" Inherits="Staff_SearchProduct" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
    ...
    <h2>Are You Sure You Want Return This Product?
        </h2>
            </td>
