<%@ Page Title="New Account Confirmation" Language="C#" MasterPageFile="~/SG_MasterPage.master" AutoEventWireup="true" CodeFile="SG_Customer_NewAccountConfirm.aspx.cs" Inherits="Staff_SearchProduct" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
    ...
    <h2>Are You Sure You Want To Create Account?
        </h2>
            </td>
