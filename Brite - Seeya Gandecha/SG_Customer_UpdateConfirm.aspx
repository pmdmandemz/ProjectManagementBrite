<%@ Page Title="Update Confirmation" Language="C#" MasterPageFile="~/SG_MasterPage.master" AutoEventWireup="true" CodeFile="SG_Customer_UpdateConfirm.aspx.cs" Inherits="Staff_SearchProduct" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
    ...
    <h2>Are You Sure You Want To Update Your Account?
        </h2>
            </td>
