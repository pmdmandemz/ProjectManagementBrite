<%@ Page Title="Create Customer Account " Language="C#" MasterPageFile="~/SG_MasterPage.master" AutoEventWireup="true" CodeFile="SG_Staff_CustomerNewDetails.aspx.cs" Inherits="Staff_SearchProduct" %>
  ...
  <tr>
    ...
    <td style="width:225px; ">       
      ...
      <td rowspan="3" style="text-align:center"> 
        <asp:ImageButton ID="Create" OnClick="Create_Click" runat="server" ImageUrl="~/Buttons/Create.jpg" Width="125PX" Height="125px" ImageAlign="Middle" />
      </td>
  </tr>
  <tr>
